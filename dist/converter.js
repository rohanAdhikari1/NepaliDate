...
export const calculateAddDays = (year, month, day, dayOfWeek, days) => {
    validateBS(year, month, day);
    while (days > 0) {
...
export const calculateAddMonths = (year, month, day, dayOfWeek, months) => {
    validateBS(year, month, day);
    let totalDays = 0;
...
export const calculateSubDays = (year, month, day, dayOfWeek, days) => {
    validateBS(year, month, day);
    while (days > 0) {
        if (day > days) {
            day -= days;
...
export const calculateSubMonths = (year, month, day, dayOfWeek, months) => {
    validateBS(year, month, day);
    let totalDays = 0;
    for (let i = 0; i < months; i++) {
        month--;
