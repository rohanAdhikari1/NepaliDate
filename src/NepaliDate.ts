...
export default class NepaliDate {
  ...
  year(year?: number): NepaliDate | number {
    if (year === undefined) return this._year;
    return new NepaliDate({
      ...this.toObject(),
      year,
  ...
  month(month?: number): NepaliDate | number {
    if (month === undefined) return this._month;
    return new NepaliDate({
      ...this.toObject(),
      month,
  ...
  hour(hour?: number): NepaliDate | number {
    if (hour === undefined) return this._hour;
    if (!validateHour(hour)) throw new Error("Invalid Hour");
    return new NepaliDate({ ...this.toObject(), hour });
  }

  minute(minute?: number): NepaliDate | number {
    if (minute === undefined) return this._minute;
    if (!validateMinuteSecond(minute)) throw new Error("Invalid Minute");
    return new NepaliDate({ ...this.toObject(), minute });
  }

  second(second?: number): NepaliDate | number {
    if (second === undefined) return this._second;
    if (!validateMinuteSecond(second)) throw new Error("Invalid Second");
  ...
  addMonths(months: number): this {
    ...
    [this._year, this._month, this._day, this._dayOfWeek] = calculateAddMonths(
      this._year,
      this._month,
      this._day,
      this._dayOfWeek,
  ...
  addYears(years: number): this {
    ...
    [this._year, this._month, this._day, this._dayOfWeek] = calculateAddYears(
      this._year,
      this._month,
      this._day,
      this._dayOfWeek,
  ...
  subDays(days: number): this {
    ...
    [this._year, this._month, this._day, this._dayOfWeek] = calculateSubDays(
      this._year,
      this._month,
      this._day,
      this._dayOfWeek,
  ...
  subMonths(months: number): this {
    ...
    [this._year, this._month, this._day, this._dayOfWeek] = calculateSubMonths(
      this._year,
      this._month,
      this._day,
      this._dayOfWeek,
  ...
  subYears(years: number): this {
    ...
    [this._year, this._month, this._day, this._dayOfWeek] = calculateSubYears(
      this._year,
      this._month,
      this._day,
      this._dayOfWeek,
